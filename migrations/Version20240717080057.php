 ...
 */
final class Version20240717080057 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT NOT NULL, nickname VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, online BOOLEAN NOT NULL, access VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1483A5E9E7927C74 ON users (email)');
        $this->addSql('CREATE TABLE video_game_articles (id INT NOT NULL, name VARCHAR(255) NOT NULL, text VARCHAR(1000) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE video_game_reviews (id INT NOT NULL, users_id INT NOT NULL, video_game_articles_id INT NOT NULL, text VARCHAR(1000) NOT NULL, grade INT NOT NULL, PRIMARY KEY(id))');
